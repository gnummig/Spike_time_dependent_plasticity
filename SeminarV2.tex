...
This property of 'learning' form the past is very similar to the plasticity of synapses. It has been proposed to use memristor arrays as synapses for artificial neural networks.
